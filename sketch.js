...
function draw() {
  ...
  if(frameCount > 1400 && frameCount < 2000 ){
    spwanEnemy();
    if(keyDown("LEFT_ARROW")){
      warrior.velocityX = -2;
      warrior.velocityY = 0;
  ...
  if(frameCount > 2500 && frameCount < 3100 ){
    spwanEnemy();
    if(keyDown("LEFT_ARROW")){
      warrior.velocityX = -2;
      warrior.velocityY = 0;
  ...
  if(frameCount > 3600 && frameCount < 4200 ){
    spwanEnemy();
    if(keyDown("LEFT_ARROW")){
      warrior.velocityX = -2;
      warrior.velocityY = 0;
  ...
  if(frameCount > 4700 && frameCount < 5300 ){
    spwanEnemy();
    //boss();
    if(keyDown("LEFT_ARROW")){
      warrior.velocityX = -2;
...
function reset(){
  warrior.position.x = 500;
  warrior.position.x = 800;
  warrior.velocityX = 0;
  warrior.velocityY = 0;
}
...
function attack(){
  if(keyDown("q")) {
    ...
    warrior.scale = 1;
    if(warrior.isTouching(spwanGroup)){
